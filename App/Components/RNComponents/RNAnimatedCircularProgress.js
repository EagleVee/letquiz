...
import RNCircularProgress from "./RNCircularProgress";

const AnimatedProgress = Animated.createAnimatedComponent(RNCircularProgress);

export default class RNAnimatedCircularProgress extends React.PureComponent {
  constructor(props) {
    super(props);
    this.state = {
...
RNAnimatedCircularProgress.propTypes = {
  ...RNCircularProgress.propTypes,
...
RNAnimatedCircularProgress.defaultProps = {
  duration: 500,
